...
Проект представляет собой data-driven исследование взаимосвязи между уровнем благосостояния и распространением электромобилей в странах Европейского союза. В периоде с 2019-го по 2024-й года.

Основной идеей исследования является выявление статистической связи между экономическим положением страны и долей электрокаров среди легковых автомобилей. В работе рассмотрены: показатели благосостояния, цены на топливо и электроэнергию, численность населения,  расходы на охрану окружающей среды.

Данные собирались из открытых источников через API и загружаемые файлы, очищались от пустых значений и после чего анализировались при помощи сравнений, корреляционного и регрессионного анализа. Итоговые графики и результаты сохранены в репозитории.

---

## Актуальность

Переход на электромобили является самой заметной тенденцией европейского транспортного рынка. Однако распространение электромобилей происходит неодинаково: страны ЕС существенно различаются по уровню доходов, потребительским возможностям, ценам на энергию и топливо, а также по экономическим условиям.
...
В данном проекте используются агрегированные данные по странам, поэтому исследование показывает взаимосвязи между странами и годами, а не делает прогнозов о том насколько вероятна покупка электромобиля.
